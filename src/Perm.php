...
final class Perm
{
    ...
    {
        // In the guided tour everything runs against an isolated demo DB, so a
        // learner of any role may try every capability without touching live data.
    ...
    {
        if (Tour::active()) return true;   // demo DB — show all sample records
