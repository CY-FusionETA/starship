...
<link rel="stylesheet" href="<?= e($base) ?>/public/css/tour.css?v=<?= @filemtime(APP_ROOT . '/public/css/tour.css') ?: '1' ?>">
</head>
<?php $tourOn = \App\Tour::active(); ?>
<body><?php if ($tourOn): ?>
<div class="stour-banner"><span class="dot"></span><span class="grow"><b>Training Mode</b> — you're on a practice copy with sample data. Nothing here touches your live system.</span><button type="button" onclick="starshipTourExit()">Exit training</button></div>
<?php endif; ?>
<div class="app">
  <aside class="sidebar">
